...
static struct { double max,min; } DoubleV;
...
VOID drawAmp(HDC rdc, RECT FAR *rF, DOUBLEARRAY d) {
...
VOID drawF(HDC rDC, RECT FAR *rF, DOUBLEARRAY da) {

  HBRUSH  hOldBrush;
  HPEN  hOldPen;
  short i,j,jb,jf,x0,y0,x1,dy,l1,l2,m;
  double  minV,maxV,mminV,mmaxV,f3,fp,fs, huge *d;
